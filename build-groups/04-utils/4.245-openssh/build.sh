...
build_install() {
	...
	install -m644 $PKG_DIR_PATH/sshd.service   /lib/systemd/system/sshd.service &&
	install -m644 $PKG_DIR_PATH/sshdat.service /lib/systemd/system/sshd@.service &&
	install -m644 $PKG_DIR_PATH/sshd.socket    /lib/systemd/system/sshd.socket &&
