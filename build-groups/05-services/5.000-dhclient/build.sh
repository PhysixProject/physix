...
build_install() {
        ...
        install -v -m644 /opt/admin/physix/build-groups/04-utilitiess/configs/dhclient/dhclient.conf  /etc/dhcp
        chroot_check $? "Install /etc/dhcp/dhclient.conf"

        install -v -m644 /opt/admin/physix/build-groups/04-utilitiess/configs/dhclient/dhclient@.service  /lib/systemd/system/
