...
build_install() {
        ...
        install -v -m644 /opt/admin/physix/build-groups/05-services/5.000-dhclient/dhclient.conf  /etc/dhcp
        chroot_check $? "Install /etc/dhcp/dhclient.conf"

        install -v -m644 /opt/admin/physix/build-groups/05-services/5.000-dhclient/dhclient@.service  /lib/systemd/system/
