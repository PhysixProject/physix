...
cp /opt/admin/physix/build-groups/02-base-system/2.010-directories/etc_passwd /etc/passwd
chroot_check $? "Wrote /etc/passwd"

cp /opt/admin/physix/build-groups/02-base-system/2.010-directories/etc_group /etc/group
