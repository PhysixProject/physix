...
cp -v /physix/build-scripts/base-config/configs/etc_eth-static.network.cfg /etc/systemd/network/10-eth-static.network
...
cp -v /physix/build-scripts/base-config/configs/etc_network_10-ether0.link.cfg /etc/systemd/network/10-ether0.link
...
cp -v /physix/build-scripts/base-config/configs/etc_hosts.cfg /etc/hosts
...
cp -v /physix/build-scripts/base-config/configs/motd /etc/motd
