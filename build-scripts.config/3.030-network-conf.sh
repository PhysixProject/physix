...
cp -v /physix/build-scripts.config/etc_network_10-ether0.linkf.cfg /etc/systemd/network/10-ether0.link
...
cp -v /physix/build-scripts.config/etc_eth-static.network.cfg /etc/systemd/network/10-eth-static.network
chroot_check $? "system config : network : cp -v etc_eth-static.network.cfg /etc/systemd/network/10-eth-static.network"

cp -v /physix/build-scripts.config/etc_hosts.cfg /etc/hosts
chroot_check $? "system config : network : cp -v etc_eth-static.network.cfg /etc/systemd/network/10-eth-static.network"
