...
def list_stack(conn):
    ...
    print('{:<6s} {:<17s} {:<10s} {:<10} {:<10s} {:<30s} {:<30s}'.format('key', 'DATE', 'OP', 'COMMIT', 'SNAP', 'PKG', 'SCRIPT' ))
    for i in range(len(stack_lst)-1, -1, -1):
        ...
        print('{:<6s} {:<17s} {:<10s} {:<10s} {:<10s} {:<30s} {:<30s}'.format(prim_key, date, op, commit, snap, pkg, script ))
    return SUCCESS
